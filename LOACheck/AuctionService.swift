...
class AuctionService {
    ...
    // 경매장 옵션 가져오기 (카테고리 정보 포함)
//    func fetchAuctionOptions(apiKey: String) async -> Result<AuctionOption, APIError> {
//        do {
//            let url = URL(string: "\(baseURL)/auctions/options")!
//            
...
//            
//            Logger.debug("경매장 옵션 API 요청: \(url.absoluteString)")
//            
...
//                let options = try decoder.decode(AuctionOption.self, from: data)
//                
//                // 전투 각인서 카테고리 코드 찾기
//                auctionCategories = options.categories
//                
//                // 여기서 전투 각인서 카테고리 코드를 찾아 저장
//                for category in options.categories {
//                    if category.codeName.contains("전투") || category.codeName.contains("각인서") {
//                        engraveBookCategoryCode = category.code
//                        break
//                    }
//                    
//                    // 하위 카테고리도 확인
//                    for sub in category.subs {
//                        if sub.codeName.contains("전투") || sub.codeName.contains("각인서") {
//                            engraveBookCategoryCode = sub.code
//                            break
//                        }
//                    }
//                }
//                
//                Logger.debug("전투 각인서 카테고리 코드: \(engraveBookCategoryCode)")
...
//            }
//        } catch {
//            Logger.error("경매장 옵션 API 오류", error: error)
